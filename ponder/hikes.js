...
const searchButton = document.getElementById("click", e => {
    console.log("you clicked the button");

    //filter arrar with whatever the user typed in
    //user input
    ...
    filteredHikes.sort(sortHikessByDifficulty);

    console.log(filteredHikes);

});

function sortHikessByDifficulty(a, b) {
